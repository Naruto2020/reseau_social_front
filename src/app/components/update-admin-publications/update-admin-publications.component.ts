...
@Component({
  selector: 'app-update-admin-publications',
  templateUrl: './update-admin-publications.component.html',
  styleUrls: ['./update-admin-publications.component.css']
})
export class UpdateAdminPublicationsComponent implements OnInit {
